...
class StringsAndObjects
{
    static void Main()
    {
        string first = "Hello";
        string second = "World";
        object congrats = first + " " + second;
        string stringCongrats = (string)congrats;

        Console.WriteLine(stringCongrats);
    }
}