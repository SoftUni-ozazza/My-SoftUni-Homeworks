namespace CohesionAndCoupling
{
    ...
    class UtilsExamples
    {
        static void Main()
        {
            ...
            Console.WriteLine("Diagonal XYZ = {0:f2}", Utils.Calc3DDiagonalXYZ());
            Console.WriteLine("Diagonal XY = {0:f2}", Utils.Calc2DDiagonalXY());
            Console.WriteLine("Diagonal XZ = {0:f2}", Utils.Calc2DDiagonalXZ());
            Console.WriteLine("Diagonal YZ = {0:f2}", Utils.Calc2DDiagonalYZ());
        }
    }
}
